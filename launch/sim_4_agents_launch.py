...
def generate_launch_description():
    ...
    # -> Add the command to record all topics into a bag file
    # # > Declare the 'bag_file' launch argument
    # nodes.append(
    #     DeclareLaunchArgument(
    #         'bag_file',
    #         default_value='0',
    #         description=f'{sim_id}'
    #     )
    # )

    # nodes.append(
    #     ExecuteProcess(
    #         cmd=['ros2', 'bag', 'record', '-a', '-o', LaunchConfiguration('scenario_id')],
    #         output='screen'
    #     )
    # )
    ...
    nodes.append(
        IncludeLaunchDescription(
            ...
            launch_arguments={'scenario_id': LaunchConfiguration('scenario_id')}.items()
        )
    )
